...
public let ruleNameCache: [ObjectIdentifier: String] = [
  ...
  ObjectIdentifier(AttributeOrder.self): "AttributeOrder",
  ...
  ObjectIdentifier(CanonicalDocComments.self): "CanonicalDocComments",
  ObjectIdentifier(CanonicalNumberLiterals.self): "CanonicalNumberLiterals",
  ObjectIdentifier(CanonicalStringEscapes.self): "CanonicalStringEscapes",
  ...
  ObjectIdentifier(GroupedDeclarations.self): "GroupedDeclarations",
  ...
  ObjectIdentifier(RedundantParens.self): "RedundantParens",
  ObjectIdentifier(RedundantRawString.self): "RedundantRawString",
